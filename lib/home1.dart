  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        children: <Widget>[
          const HomeScreenTop(),
          HomeScreenBottom(isFlightSelected: true),
        ],
      ),
    );
  }
...
class _HomeScreenTopState extends State<HomeScreenTop> {
  final TextStyle dropdownMenuLabel = const TextStyle(color: Colors.white, fontSize: 16);
        ...
        ClipPath(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(colors: [Color(0xfffb53c6), Color(0xffb91d73)]),
            ),
            child: Column(
              children: <Widget>[
...
class HomeScreenBottom extends StatelessWidget {
  ...
  const HomeScreenBottom({Key? key, required this.isFlightSelected}) : super(key: key);
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: isFlightSelected ? flightCityCards : hotelCityCards,
          ),
        ),
      ],
    );
...
class ChoiceChip extends StatefulWidget {
  ...
  const ChoiceChip(this.icon, this.text, this.isflightSelected, {Key? key}) : super(key: key);
